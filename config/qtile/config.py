...
keys = [
    ...
    Key([mod], "x", lazy.spawn("rofi -show drun -columns 3")),
    Key([mod], "w", lazy.spawn("rofi -show window")),

    Key([], 'Print', lazy.spawn("scrot")),
    Key([mod], "h", lazy.spawn("scrot -s")),
...
layouts = [
    layout.MonadTall(border_focus="#196ff2", border_width=1),
    layout.Max()
]
...
def startup():
    def blocking():
        ...
        execute_once(['fcitx'])
        execute_once(["xmodmap -e 'clear Lock' -e  'keycode 0x42 = Escape'"])
